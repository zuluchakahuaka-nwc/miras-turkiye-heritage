...
const List<Site> kSites = [
  Site(
    ...
    gettingThere: L10nText(
      'Из Стамбула — самолёт до Шанлыурфы (≈1,5 ч); на авто — по E80/O-4 до Анкары и далее через Газиантеп по автобану O-52; от центра Шанлыурфы ~15 км: такси или сезонный шаттл от Археологического музея.',
      'İstanbul\'dan Şanlıurfa\'ya uçak (≈1,5 saat); araçla E80/O-4 üzerinden, Gaziantep\'ten O-52 otoyoluyla; merkezden 15 km: taksi ya da Arkeoloji Müzesi\'nden sezonluk servis.',
      'From Istanbul — flight to Şanlıurfa (≈1.5 h); by car — E80/O-4 to Ankara, then the O-52 motorway via Gaziantep; ~15 km from the centre: taxi or the seasonal museum shuttle.',
    ),
    wikiRu: 'Гёбекли-Тепе',
    wikiEn: 'Göbekli Tepe',
  ),
  Site(
    ...
    gettingThere: L10nText(
      'Из Стамбула — самолёт до Коньи (~1,5 ч) или скоростной поезд YHT через Эскишехир (~4–5 ч); от Коньи ~50 км на юго-восток по трассе D715 (направление Караман—Чумра), от Чумры ~8 км на восток: авто или такси; указатели Çatalhöyük.',
      'İstanbul\'dan Konya\'ya uçak (~1,5 saat) ya da Eskişehir üzerinden YHT hızlı tren (~4–5 saat); Konya\'dan D715 (Karaman–Çumra yönü) ile ≈50 km güneydoğuya, Çumra\'dan ≈8 km doğuya: araç ya da taksi; Çatalhöyük tabelaları.',
      'From Istanbul — flight to Konya (~1.5 h) or the YHT fast train via Eskişehir (~4–5 h); from Konya ~50 km southeast on the D715 (towards Karaman–Çumra), then ~8 km east of Çumra: car or taxi; signposted «Çatalhöyük».',
    ),
    wikiRu: 'Чатал-Хююк',
    wikiEn: 'Çatalhöyük',
  ),
  Site(
    ...
    gettingThere: L10nText(
      'Из Анкары по D100/O-4 на запад до Полатлы (поезд или автобус), оттуда 10 км до Яссыхёюка; удобнее авто, указатели Gordion.',
      'Ankara\'dan D100/O-4 üzeri Polatlı\'ya (tren/otobüs), sonra Yassıhöyük\'e 10 km; en pratiği araç, Gordion tabelaları.',
      'From Ankara west on the D100/O-4 to Polatlı (train or coach), then 10 km to Yassıhöyük; easiest by car, signposted «Gordion».',
    ),
    wikiRu: 'Гордион',
    wikiEn: 'Gordion',
  ),
  Site(
    ...
    gettingThere: L10nText(
      'Из Анкары ~200 км на восток: по O-4/E80 и далее по указателям на Чорум (авто, ≈3 ч); летом — экскурсии из Анкары и Чорума; из Чорума 30 км на юг.',
      'Ankara\'dan 200 km doğuya: O-4/E80 üzerinden Çorum istikameti (araçla ≈3 saat); yazın Ankara ve Çorum\'dan turlar; Çorum\'dan 30 km güneye.',
      '~200 km east of Ankara: via the O-4/E80 towards Çorum by car (≈3 h); seasonal tours from Ankara and Çorum; 30 km south of Çorum.',
    ),
    wikiRu: 'Хаттуса',
    wikiEn: 'Hattusa',
  ),
  Site(
    ...
    gettingThere: L10nText(
      'Из Измира по трассе D300 (направление Ушак) до Салихли (75 км, автобус или поезд), затем 10 км до деревни Сарт; удобнее авто.',
      'İzmir\'den D300 (Uşak yönü) üzerinden Salihli\'ye 75 km (otobüs/tren), sonra Sart köyüne 10 km; araç pratik.',
      'From İzmir on the D300 (towards Uşak) to Salihli (75 km, coach or train), then 10 km to Sart village; a car is handier.',
    ),
    wikiRu: 'Сарды',
    wikiEn: 'Sardis',
  ),
  Site(
    ...
    gettingThere: L10nText(
      'Из Стамбула — по E84/D550 до Гелиболу, паром через Дарданеллы (E90) до Чанаккале (всего ≈5 ч), далее 30 км до деревни Тэвфикие.',
      'İstanbul\'dan E84/D550 ile Gelibolu\'ya, Çanakkale feribotu (E90), toplam ≈5 saat; sonra Tevfikiye köyüne 30 km.',
      'From Istanbul — E84/D550 to Gelibolu, the Dardanelles ferry (E90) to Çanakkale (≈5 h in all), then 30 km to Tevfikiye village.',
    ),
    wikiRu: 'Троя',
    wikiEn: 'Troy',
  ),
  Site(
    ...
    gettingThere: L10nText(
      'Ближайший город — Сельчук (3 км): из Измира по автобану O-31 (съезд на Сельчук) или поезд/автобус ~1 ч; аэропорты Измир (60 км) и Бодрум (130 км).',
      'En yakın merkez Selçuk (3 km): İzmir\'den O-31 otoyolu (Selçuk çıkışı) ya da tren/otobüs ~1 saat; havalimanları İzmir (60 km) ve Bodrum (130 km).',
      'Nearest town is Selçuk (3 km): from İzmir on the O-31 motorway (Selçuk exit) or ~1 h by train/coach; airports at İzmir (60 km) and Bodrum (130 km).',
    ),
    wikiRu: 'Эфес',
    wikiEn: 'Ephesus',
  ),
  ...
  Site(
    ...
    gettingThere: L10nText(
      'Бергама — 105 км к северу от Измира по трассе D550 (направление Чанаккале; автобус ≈2 ч); к акрополю ведёт канатная дорога; из Стамбула ≈6 ч или самолёт до Измира.',
      'Bergama, İzmir\'in 105 km kuzeyinde, D550 (Çanakkale yönü) üzeri (otobüs ≈2 saat); akropole teleferik; İstanbul\'dan ≈6 saat ya da İzmir uçuşu.',
      'Bergama is 105 km north of İzmir on the D550 (towards Çanakkale; coach ≈2 h); a cable car climbs to the acropolis; from Istanbul ≈6 h or fly to İzmir.',
    ),
    wikiRu: 'Пергам',
    wikiEn: 'Pergamon',
  ),
  Site(
    ...
    gettingThere: L10nText(
      'Из Измира по автобану O-31 до Айдына, далее через Соке на юг к Дидиму и Балату (~120 км); из Кушадасы ~50 км; удобнее авто.',
      'İzmir\'den O-31 ile Aydın\'a, sonra Söke üzerinden güneye Didim/Balat (~120 km); Kuşadası\'ndan ≈50 km; araçla kolay.',
      'From İzmir on the O-31 to Aydın, then south via Söke to Didim and Balat (~120 km); ~50 km from Kuşadası; easiest by car.',
    ),
    wikiRu: 'Милет',
    wikiEn: 'Miletus',
  ),
  Site(
    ...
    gettingThere: L10nText(
      'По автобану O-31 и трассе D320 до Денизли, затем ~100 км на юго-восток через Карасую; транспорта мало — лучше авто, указатели Geyre/Afrodisias.',
      'O-31 ve D320 ile Denizli\'ye, sonra Karacasu üzerinden ≈100 km güneydoğuya; toplu taşıma az — araç önerilir, Geyre/Afrodisias tabelaları.',
      'Via the O-31 and D320 to Denizli, then ~100 km southeast through Karacasu; public transport is scarce — a car is best; follow Geyre/Aphrodisias signs.',
    ),
    wikiRu: 'Афродисиас',
    wikiEn: 'Aphrodisias',
  ),
  ...
  Site(
    ...
    gettingThere: L10nText(
      'По автобану O-31 и трассе D320 до Денизли, далее 20 км на север (долмуш или такси, 30 мин); из Измира ~4 ч; по травертинам ходят босиком.',
      'O-31 ve D320 ile Denizli\'ye, sonra 20 km kuzeye (dolmuş/taksi, 30 dk); İzmir\'den ≈4 saat; travertenlere yalın ayak girilir.',
      'Via the O-31 and D320 to Denizli, then 20 km north (dolmuş/taxi, 30 min); ~4 h from İzmir; you walk the travertines barefoot.',
    ),
    wikiRu: 'Памуккале',
    wikiEn: 'Pamukkale',
  ),
  ...
  Site(
    ...
    gettingThere: L10nText(
      'Бодрум, центр: от Миласа по трассе D525; от гавани 15 мин пешком в гору; аэропорт Бодрум (BJV) 35 км; из Измира автобус ≈4 ч.',
      'Bodrum merkez: Milas\'tan D525 üzerinden; marinanın üstünde 15 dk yürüyüş; Bodrum (BJV) havalimanı 35 km; İzmir\'den otobüs ≈4 saat.',
      'Central Bodrum: from Milas on the D525; a 15-minute uphill walk from the marina; Bodrum airport (BJV) 35 km; ~4 h from İzmir by coach.',
    ),
